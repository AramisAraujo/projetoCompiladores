...
public class GoGrammarAccess extends AbstractGrammarElementFinder {
	...
	public GoGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.tWS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.Go.WS");
		this.tCOMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.Go.COMMENT");
		this.tTERMINATOR = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.Go.TERMINATOR");
		this.tLINE_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.Go.LINE_COMMENT");
	}
