 ...
 * <ul>
 *   <li>{@link org.xtext.go.recvStmt#getExpressionList <em>Expression List</em>}</li>
 *   <li>{@link org.xtext.go.recvStmt#getIdentifierList <em>Identifier List</em>}</li>
 *   <li>{@link org.xtext.go.recvStmt#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.go.GoPackage#getrecvStmt()
 * @model
 * @generated
 */
public interface recvStmt extends EObject
{
   ...
   * @see org.xtext.go.GoPackage#getrecvStmt_ExpressionList()
  ...
  /**
   * Sets the value of the '{@link org.xtext.go.recvStmt#getExpressionList <em>Expression List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.go.GoPackage#getrecvStmt_IdentifierList()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.go.recvStmt#getIdentifierList <em>Identifier List</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.go.GoPackage#getrecvStmt_Expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.go.recvStmt#getExpression <em>Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
