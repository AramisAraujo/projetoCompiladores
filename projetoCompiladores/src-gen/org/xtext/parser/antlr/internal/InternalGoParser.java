...
public class InternalGoParser extends AbstractInternalAntlrParser {
    ...
    public static final int RULE_SEND_STMT=133;
    ...
    public static final int RULE_LABEL=136;
    public static final int T__167=167;
    public static final int RULE_NEWLINE=5;
    public static final int RULE_PRIMARY_EXPR=105;
    public static final int RULE_IF_STMT=126;
    public static final int RULE_BIG_U_VALUE=29;
    public static final int RULE_ESCAPED_CHAR=30;
    public static final int RULE_KEY=100;
    public static final int RULE_PARAMETER_LIST=51;
    public static final int RULE_FUNCTION_NAME=86;
    public static final int RULE_KEY_TYPE=66;
    public static final int RULE_ALIAS_DECL=82;
    public static final int RULE_COMPOSITE_LIT=93;
    public static final int RULE_RANGE_CLAUSE=148;
    public static final int RULE_BYTE_VALUE=26;
    public static final int RULE_OPERAND=91;
    public static final int RULE_INTERFACE_TYPE=48;
    public static final int RULE_TOP_LEVEL_DECL=77;
    public static final int RULE_BASIC_LIT=92;
    ...
    public static final int RULE_ASSIGNMENT=135;
    ...
    public static final int RULE_SIMPLE_STMT=119;
    public static final int RULE_MAP_TYPE=50;
    public static final int RULE_BLOCK=69;
    public static final int RULE_EXPR_SWITCH_CASE=141;
    public static final int RULE_KEYED_ELEMENT=99;
    public static final int RULE_FUNCTION_BODY=87;
    public static final int RULE_INTERFACE_TYPE_NAME=65;
    public static final int RULE_FUNCTION_DECL=75;
    public static final int RULE_TYPE_CASE_CLAUSE=143;
    public static final int RULE_FIELD_NAME=102;
    ...
    public static final int RULE_FOR_STMT=129;
    public static final int RULE_SELECTOR=106;
    public static final int RULE_UNARY_OP=114;
    ...
    public static final int RULE_CONVERSION=103;
    public static final int RULE_DECIMAL_LIT=17;
    public static final int RULE_DECLARATION=74;
    public static final int RULE_FIELD_DECL=54;
    public static final int RULE_TAG=57;
    public static final int RULE_CONST_DECL=71;
    public static final int RULE_ELEMENT_LIST=98;
    public static final int RULE_LABELED_STMT=118;
    public static final int RULE_COMM_CASE=152;
    public static final int RULE_QUALIFIED_IDENT=43;
    public static final int RULE_SLICE=108;
    public static final int RULE_CONDITION=146;
    public static final int RULE_EXPRESSION_LIST=79;
    public static final int RULE_TYPE_ASSERTION=109;
    public static final int RULE_BINARY_OP=113;
    public static final int RULE_SWITCH_STMT=127;
    public static final int RULE_RETURN_STMT=121;
    public static final int RULE_IMAGINARY_LIT=24;
    public static final int RULE_STRING_LIT=35;
    public static final int RULE_EMPTY_STMT=131;
    public static final int RULE_BASE_TYPE=58;
    public static final int RULE_VAR_SPEC=84;
    public static final int RULE_BREAK_STMT=122;
    public static final int RULE_TYPE_SWITCH_GUARD=142;
    public static final int RULE_INTERPRETED_STRING_LIT=34;
    public static final int RULE_TYPE_LIT=41;
    public static final int RULE_METHOD_EXPR=104;
    public static final int RULE_UNICODE_VALUE=25;
    public static final int RULE_LITTLE_U_VALUE=28;
    public static final int RULE_VAR_DECL=73;
    public static final int RULE_COMM_CLAUSE=151;
    public static final int RULE_HEX_BYTE_VALUE=32;
    public static final int RULE_OCTAL_BYTE_VALUE=31;
    public static final int RULE_MUL_OP=117;
    public static final int RULE_TYPE=42;
    public static final int RULE_ARRAY_LENTGH=52;
    public static final int RULE_CONST_SPEC=78;
    public static final int RULE_INIT_STMT=149;
    public static final int RULE_SEMICOLON=38;
    public static final int RULE_UNARY_EXPR=112;
    public static final int RULE_GOTO_STMT=124;
    public static final int RULE_LITERAL_TYPE=96;
    public static final int RULE_INDEX=107;
    ...
    public static final int RULE_EXPRESSION=80;
    public static final int RULE_GO_STMT=120;
    public static final int RULE_ELEMENT=101;
    public static final int RULE_DEFER_STMT=130;
    public static final int RULE_SL_COMMENT=163;
    public static final int RULE_RECV_STMT=153;
    public static final int RULE_TOKEN=39;
    public static final int RULE_HEX_LIT=19;
    public static final int RULE_OPERAND_NAME=90;
    public static final int RULE_CHANNEL=137;
    public static final int EOF=-1;
    public static final int RULE_ADD_OP=116;
    public static final int RULE_PARAMETERS=60;
    public static final int RULE_TYPE_SPEC=81;
    ...
    public static final int RULE_EXPR_CASE_CLAUSE=140;
    public static final int RULE_METHOD_SPEC=63;
    public static final int RULE_RECIEVER=88;
    ...
    public static final int RULE_SHORT_VAR_DECL=85;
    public static final int RULE_TYPE_SWITCH_CASE=144;
    public static final int RULE_POST_STMT=150;
    public static final int RULE_PACKAGE_CLAUSE=155;
    public static final int RULE_FLOAT_LIT=23;
    public static final int RULE_SOURCE_FILE=157;
    public static final int RULE_METHOD_DECL=76;
    public static final int RULE_EXPRESSION_STMT=132;
    public static final int RULE_INT_LIT=20;
    public static final int RULE_FUNCTION_TYPE=47;
    public static final int RULE_IMPORT_PATH=159;
    public static final int RULE_EMBEDDED_FIELD=56;
    public static final int RULE_REL_OP=115;
    public static final int RULE_TYPE_DECL=72;
    public static final int RULE_TYPE_LIST=145;
    public static final int RULE_POINTER_TYPE=46;
    public static final int RULE_SELECT_STMT=128;
    ...
    public final EObject ruleGreeting() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,166,FOLLOW_166_in_ruleGreeting178); 
            ...
            otherlv_2=(Token)match(input,167,FOLLOW_167_in_ruleGreeting226); 
    ...
    public static final BitSet FOLLOW_ruleGreeting_in_ruleModel111 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000004000000000L});
    ...
    public static final BitSet FOLLOW_166_in_ruleGreeting178 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleGreeting199 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000008000000000L});
    public static final BitSet FOLLOW_167_in_ruleGreeting226 = new BitSet(new long[]{0x0000000000000002L});
