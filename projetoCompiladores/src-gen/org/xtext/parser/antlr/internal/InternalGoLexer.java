...
public class InternalGoLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:144:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalGo.g:144:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalGo.g:144:11: ( '^' )?
            int alt1=2;
            ...
            // InternalGo.g:144:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:146:10: ( ( '0' .. '9' )+ )
            // InternalGo.g:146:12: ( '0' .. '9' )+
            {
            // InternalGo.g:146:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:150:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGo.g:150:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGo.g:150:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:154:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalGo.g:154:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalGo.g:154:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public void mTokens() throws RecognitionException {
        // InternalGo.g:1:8: ( T__11 | T__12 | RULE_ID | RULE_INT | RULE_STRING | RULE_ML_COMMENT | RULE_SL_COMMENT | RULE_WS | RULE_ANY_OTHER )
        int alt12=9;
        ...
        switch (alt12) {
            ...
            case 5 :
                ...
                break;
            case 6 :
                // InternalGo.g:1:51: RULE_ML_COMMENT
                {
                mRULE_ML_COMMENT(); 
                ...
                break;
            case 7 :
                // InternalGo.g:1:67: RULE_SL_COMMENT
                {
                mRULE_SL_COMMENT(); 
            ...
            case 8 :
                ...
                break;
            case 9 :
                // InternalGo.g:1:91: RULE_ANY_OTHER
                {
                mRULE_ANY_OTHER(); 
