...
public class GoParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GoGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSliceAccess().getAlternatives_2(), "rule__Slice__Alternatives_2");
			...
			builder.put(grammarAccess.getPrimaryExprSelectorAccess().getGroup_1(), "rule__PrimaryExprSelector__Group_1__0");
			builder.put(grammarAccess.getPrimaryExprIndexAccess().getGroup(), "rule__PrimaryExprIndex__Group__0");
			builder.put(grammarAccess.getPrimaryExprIndexAccess().getGroup_1(), "rule__PrimaryExprIndex__Group_1__0");
			builder.put(grammarAccess.getPrimaryExprSliceAccess().getGroup(), "rule__PrimaryExprSlice__Group__0");
			builder.put(grammarAccess.getPrimaryExprSliceAccess().getGroup_1(), "rule__PrimaryExprSlice__Group_1__0");
			builder.put(grammarAccess.getPrimaryExprTypeAssertionAccess().getGroup(), "rule__PrimaryExprTypeAssertion__Group__0");
			builder.put(grammarAccess.getPrimaryExprTypeAssertionAccess().getGroup_1(), "rule__PrimaryExprTypeAssertion__Group_1__0");
			builder.put(grammarAccess.getPrimaryExprArgumentsAccess().getGroup(), "rule__PrimaryExprArguments__Group__0");
			builder.put(grammarAccess.getPrimaryExprArgumentsAccess().getGroup_1(), "rule__PrimaryExprArguments__Group_1__0");
			...
			builder.put(grammarAccess.getSliceAccess().getGroup_2_0(), "rule__Slice__Group_2_0__0");
			builder.put(grammarAccess.getSliceAccess().getGroup_2_1(), "rule__Slice__Group_2_1__0");
			...
			builder.put(grammarAccess.getExpressionMatchedAccess().getGroup_1(), "rule__ExpressionMatched__Group_1__0");
			...
			builder.put(grammarAccess.getImportDeclAccess().getSpecsAssignment_2_0(), "rule__ImportDecl__SpecsAssignment_2_0");
			builder.put(grammarAccess.getImportDeclAccess().getSpecsAssignment_2_1_1_0(), "rule__ImportDecl__SpecsAssignment_2_1_1_0");
			...
			builder.put(grammarAccess.getConstDeclAccess().getSpecAssignment_2_0(), "rule__ConstDecl__SpecAssignment_2_0");
			builder.put(grammarAccess.getConstDeclAccess().getSpecAssignment_2_1_1_0(), "rule__ConstDecl__SpecAssignment_2_1_1_0");
			...
			builder.put(grammarAccess.getTypeDeclAccess().getSpecAssignment_2_0(), "rule__TypeDecl__SpecAssignment_2_0");
			builder.put(grammarAccess.getTypeDeclAccess().getSpecAssignment_2_1_1_0(), "rule__TypeDecl__SpecAssignment_2_1_1_0");
			...
			builder.put(grammarAccess.getVarDeclAccess().getSpecsAssignment_2_0(), "rule__VarDecl__SpecsAssignment_2_0");
			builder.put(grammarAccess.getVarDeclAccess().getSpecsAssignment_2_1_1_0(), "rule__VarDecl__SpecsAssignment_2_1_1_0");
			...
			builder.put(grammarAccess.getReturnStmtAccess().getExprListAssignment_2(), "rule__ReturnStmt__ExprListAssignment_2");
			...
			builder.put(grammarAccess.getExprSwitchStmtAccess().getExprAssignment_3(), "rule__ExprSwitchStmt__ExprAssignment_3");
			builder.put(grammarAccess.getExprSwitchStmtAccess().getExprCaseClausesAssignment_5(), "rule__ExprSwitchStmt__ExprCaseClausesAssignment_5");
			...
			builder.put(grammarAccess.getSelectStmtAccess().getCommClausesAssignment_3(), "rule__SelectStmt__CommClausesAssignment_3");
			...
			builder.put(grammarAccess.getForClauseAccess().getStatement1Assignment_1(), "rule__ForClause__Statement1Assignment_1");
			builder.put(grammarAccess.getForClauseAccess().getExprAssignment_3(), "rule__ForClause__ExprAssignment_3");
			builder.put(grammarAccess.getForClauseAccess().getStatement2Assignment_5(), "rule__ForClause__Statement2Assignment_5");
			...
			builder.put(grammarAccess.getInterfaceTypeAccess().getMethodSpecsAssignment_3_0(), "rule__InterfaceType__MethodSpecsAssignment_3_0");
			...
			builder.put(grammarAccess.getParametersAccess().getParamListAssignment_2_0(), "rule__Parameters__ParamListAssignment_2_0");
			...
			builder.put(grammarAccess.getStructTypeAccess().getFieldsDeclAssignment_3_0(), "rule__StructType__FieldsDeclAssignment_3_0");
			...
			builder.put(grammarAccess.getPrimaryExprSelectorAccess().getContentAssignment_1_0(), "rule__PrimaryExprSelector__ContentAssignment_1_0");
			builder.put(grammarAccess.getPrimaryExprSelectorAccess().getPrimaryExprSelectorAssignment_1_1(), "rule__PrimaryExprSelector__PrimaryExprSelectorAssignment_1_1");
			builder.put(grammarAccess.getPrimaryExprIndexAccess().getContentAssignment_1_0(), "rule__PrimaryExprIndex__ContentAssignment_1_0");
			builder.put(grammarAccess.getPrimaryExprIndexAccess().getPrimaryExprIndexAssignment_1_1(), "rule__PrimaryExprIndex__PrimaryExprIndexAssignment_1_1");
			builder.put(grammarAccess.getPrimaryExprSliceAccess().getContentAssignment_1_0(), "rule__PrimaryExprSlice__ContentAssignment_1_0");
			builder.put(grammarAccess.getPrimaryExprSliceAccess().getPrimaryExprSliceAssignment_1_1(), "rule__PrimaryExprSlice__PrimaryExprSliceAssignment_1_1");
			builder.put(grammarAccess.getPrimaryExprTypeAssertionAccess().getContentAssignment_1_0(), "rule__PrimaryExprTypeAssertion__ContentAssignment_1_0");
			builder.put(grammarAccess.getPrimaryExprTypeAssertionAccess().getPrimaryExprTypeAssertionAssignment_1_1(), "rule__PrimaryExprTypeAssertion__PrimaryExprTypeAssertionAssignment_1_1");
			builder.put(grammarAccess.getPrimaryExprArgumentsAccess().getContentAssignment_1_0(), "rule__PrimaryExprArguments__ContentAssignment_1_0");
			builder.put(grammarAccess.getPrimaryExprArgumentsAccess().getPrimaryExprArgumentsAssignment_1_1(), "rule__PrimaryExprArguments__PrimaryExprArgumentsAssignment_1_1");
			...
			builder.put(grammarAccess.getSliceAccess().getExpr1Assignment_2_0_0(), "rule__Slice__Expr1Assignment_2_0_0");
			builder.put(grammarAccess.getSliceAccess().getExpr2Assignment_2_0_2(), "rule__Slice__Expr2Assignment_2_0_2");
			builder.put(grammarAccess.getSliceAccess().getExpr1Assignment_2_1_0(), "rule__Slice__Expr1Assignment_2_1_0");
			builder.put(grammarAccess.getSliceAccess().getExpr2Assignment_2_1_2(), "rule__Slice__Expr2Assignment_2_1_2");
			builder.put(grammarAccess.getSliceAccess().getExpr3Assignment_2_1_4(), "rule__Slice__Expr3Assignment_2_1_4");
			...
			builder.put(grammarAccess.getExpressionMatchedAccess().getOperatorAssignment_1_0(), "rule__ExpressionMatched__OperatorAssignment_1_0");
			builder.put(grammarAccess.getExpressionMatchedAccess().getExpressionAssignment_1_1(), "rule__ExpressionMatched__ExpressionAssignment_1_1");
