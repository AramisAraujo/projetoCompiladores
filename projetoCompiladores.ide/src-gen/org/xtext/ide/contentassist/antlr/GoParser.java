...
public class GoParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GoGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTypeAccess().getContentTAssignment_0(), "rule__Type__ContentTAssignment_0");
			builder.put(grammarAccess.getTypeAccess().getContentLAssignment_1(), "rule__Type__ContentLAssignment_1");
			...
			builder.put(grammarAccess.getBasicLitAccess().getBoolLitAssignment_5(), "rule__BasicLit__BoolLitAssignment_5");
