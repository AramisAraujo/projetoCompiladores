...
public class GoParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GoGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_0(), "rule__Statement__ContentAssignment_0");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_1(), "rule__Statement__ContentAssignment_1");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_2(), "rule__Statement__ContentAssignment_2");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_3(), "rule__Statement__ContentAssignment_3");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_4(), "rule__Statement__ContentAssignment_4");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_5(), "rule__Statement__ContentAssignment_5");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_6(), "rule__Statement__ContentAssignment_6");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_7(), "rule__Statement__ContentAssignment_7");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_8(), "rule__Statement__ContentAssignment_8");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_9(), "rule__Statement__ContentAssignment_9");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_10(), "rule__Statement__ContentAssignment_10");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_11(), "rule__Statement__ContentAssignment_11");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_12(), "rule__Statement__ContentAssignment_12");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_13(), "rule__Statement__ContentAssignment_13");
			builder.put(grammarAccess.getStatementAccess().getContentAssignment_14(), "rule__Statement__ContentAssignment_14");
			...
			builder.put(grammarAccess.getTypeLitAccess().getLitAssignment_0(), "rule__TypeLit__LitAssignment_0");
			builder.put(grammarAccess.getTypeLitAccess().getLitAssignment_1(), "rule__TypeLit__LitAssignment_1");
			builder.put(grammarAccess.getTypeLitAccess().getLitAssignment_2(), "rule__TypeLit__LitAssignment_2");
			builder.put(grammarAccess.getTypeLitAccess().getLitAssignment_3(), "rule__TypeLit__LitAssignment_3");
			builder.put(grammarAccess.getTypeLitAccess().getLitAssignment_4(), "rule__TypeLit__LitAssignment_4");
			builder.put(grammarAccess.getTypeLitAccess().getLitAssignment_5(), "rule__TypeLit__LitAssignment_5");
			builder.put(grammarAccess.getTypeLitAccess().getLitAssignment_6(), "rule__TypeLit__LitAssignment_6");
			builder.put(grammarAccess.getTypeLitAccess().getLitAssignment_7(), "rule__TypeLit__LitAssignment_7");
			...
			builder.put(grammarAccess.getPrimaryExprAccess().getContentAssignment_0_0(), "rule__PrimaryExpr__ContentAssignment_0_0");
			builder.put(grammarAccess.getPrimaryExprAccess().getContentAssignment_0_1(), "rule__PrimaryExpr__ContentAssignment_0_1");
			builder.put(grammarAccess.getPrimaryExprAccess().getContentAssignment_1(), "rule__PrimaryExpr__ContentAssignment_1");
			builder.put(grammarAccess.getPrimaryExprAccess().getContentAssignment_2(), "rule__PrimaryExpr__ContentAssignment_2");
			builder.put(grammarAccess.getPrimaryExprAccess().getContentAssignment_3(), "rule__PrimaryExpr__ContentAssignment_3");
			builder.put(grammarAccess.getPrimaryExprAccess().getContentAssignment_4(), "rule__PrimaryExpr__ContentAssignment_4");
			builder.put(grammarAccess.getPrimaryExprAccess().getContentAssignment_5(), "rule__PrimaryExpr__ContentAssignment_5");
			builder.put(grammarAccess.getPrimaryExprStuffAccess().getContentAssignment_0(), "rule__PrimaryExprStuff__ContentAssignment_0");
			builder.put(grammarAccess.getPrimaryExprStuffAccess().getContentAssignment_1(), "rule__PrimaryExprStuff__ContentAssignment_1");
			builder.put(grammarAccess.getPrimaryExprStuffAccess().getContentAssignment_2(), "rule__PrimaryExprStuff__ContentAssignment_2");
			builder.put(grammarAccess.getPrimaryExprStuffAccess().getContentAssignment_3(), "rule__PrimaryExprStuff__ContentAssignment_3");
			builder.put(grammarAccess.getPrimaryExprStuffAccess().getContentAssignment_4(), "rule__PrimaryExprStuff__ContentAssignment_4");
